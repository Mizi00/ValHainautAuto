...
<div class="mention-content">
    ...
    <p>– le gérant du site internet, ci-après désigné « Toufik »,</p>
    <p>– toute personne souhaitant accéder au site et à ses services, ci-après appelé « Toufik ».</p>
    <p>Pour tous contact avec Toufik envoyer un mail à <a href="mailto:toufikboukichou2@gmail.com">toufikboukichou2@gmail.com</a></p>
    <br>
    <h2> ARTICLE 1 – PRINCIPES</h2>
    <p> Les présentes conditions générales d’utilisation ont pour objet l’encadrement juridique de l’utilisation du site Valhainautauto et de ses services. Le site Internet https://www.valhainautauto.fr est un service de :<br /> Val Hainaut Auto, 64 bis Avenue Faubourg de Cambrai, 59300 Valenciennes<br /> · adresse URL du site : https://valhainautauto.fr<br /> · e-mail : contact@valhainautauto.fr<br /> · numéro de téléphone : 06.78.65.81.21 / 09.82.46.74.49.<br /> Les conditions générales d’utilisation doivent être acceptées par tout Utilisateur, et son accès au site vaut acceptation de ces conditions.</p>
    <br>
    <h2> ARTICLE 2 – EVOLUTION ET DUREE DES CGU</h2>
    <p> Les présentes conditions générales d’utilisation sont conclues pour une durée indéterminée. Le contrat produit ses effets à l’égard de l’Utilisateur à compter du début de l’utilisation du service. Le site Valhainautauto se réserve le droit de modifier les clauses de ces conditions générales d’utilisation à tout moment et sans justification.</p>
    <br>
    <h2> ARTICLE 3 – ACCES AU SITE</h2>
    <p> Tout Utilisateur ayant accès à internet peut accéder gratuitement et depuis n’importe où au site Valhainautauto. Les frais supportés par l’Utilisateur pour y accéder (connexion internet, matériel informatique, etc.) ne sont pas à la charge de l’Éditeur. Le site et ses différents services peuvent être interrompus ou suspendus par l’Éditeur, notamment à l’occasion d’une maintenance, sans obligation de préavis ou de justification. L’Utilisateur du site a accès aux services suivants : Services webmarketing. Le site comprend un espace membre payant réservé aux utilisateurs inscrits. Ces utilisateurs pourront y accéder en utilisant leurs identifiants de connexion. Les services réservés aux membres sont les suivants : Tutoriels, forum.</p>
    <br>
    <h2> ARTICLE 4 – RESPONSABILITES</h2>
    <p> La responsabilité de l’Éditeur ne peut être engagée en cas de défaillance, panne, difficulté ou interruption de fonctionnement, empêchant l’accès au site ou à une de ses fonctionnalités. Le matériel de connexion au site utilisée est sous l’entière responsabilité de l’Utilisateur qui doit prendre toutes les mesures appropriées pour protéger le matériel et les données notamment d’attaques virales par Internet. L’utilisateur est par ailleurs le seul responsable des sites et données qu’il consulte. L’Éditeur ne pourra être tenu responsable en cas de poursuites judiciaires à l’encontre de l’Utilisateur : – du fait de l’usage du site ou de tout service accessible via Internet ; – du fait du non-respect par l’Utilisateur des présentes conditions générales. L’Éditeur n’est pas responsable des dommages causés à l’Utilisateur, à des tiers et/ou à l’équipement de l’Utilisateur du fait de sa connexion ou de son utilisation du site et l’Utilisateur renonce à toute action contre l’Éditeur de ce fait. Si l’Éditeur venait à faire l’objet d’une procédure amiable ou judiciaire à raison de l’utilisation du site par l’Utilisateur, il pourra retourner contre lui pour obtenir indemnisation de tous les préjudices, sommes, condamnations et frais qui pourraient découler de cette procédure.</p>
    <br>
    <h2> ARTICLE 5 – PROPRIETE INTELLECTUELLE</h2>
    <p> Tous les documents techniques, produits, photographies, textes, logos, dessins, vidéos, etc., sont soumis à des droits d’auteur et sont protégés par le Code de la propriété intellectuelle. Lorsqu’ils sont remis à nos clients, ils demeurent la propriété exclusive de Val Hainaut Auto, seul titulaire des droits de propriété intellectuelle sur ces documents, qui doivent lui être rendus à sa demande. Nos clients s’engagent à ne faire aucun usage de ces documents, susceptible de porter atteinte aux droits de propriété industrielle ou intellectuelle du fournisseur et s’engagent à ne les divulguer à aucun tiers, en dehors d’une autorisation expresse et préalable donnée par l’Editeur.</p>
    <br>
    <h2> ARTICLE 6 – LIENS HYPERTEXTES</h2>
    <p> La mise en place par l’Utilisateur de tous liens hypertextes vers tout ou partie du site est strictement interdite, sauf autorisation préalable et écrite de l’Éditeur, sollicitée par courriel à l’adresse suivante : contact@valhainautauto.fr. L’Éditeur est libre de refuser cette autorisation sans avoir à justifier de quelque manière que ce soit sa décision. Dans le cas où l’Éditeur accorderait son autorisation, celle-ci n’est dans tous les cas que temporaire et pourra être retirée à tout moment, sans obligation de justification à la charge de l’Éditeur. Dans tous les cas, tout lien devra être retiré sur simple demande de l’Éditeur. Toute information accessible via un lien vers d’autres sites n’est pas sous le contrôle de l’Éditeur qui décline toute responsabilité quant à leur contenu.</p>
    <br>
    <h2> ARTICLE 7 – PROTECTION DES DONNEES PERSONNELLES</h2>
    <p> Données collectées<br /> Les données à caractère personnel qui sont collectées sur ce site sont les suivantes :</p>
    <p>– ouverture de compte : lors de la création du compte de l’utilisateur : nom ; prénom ; adresse électronique ; n° de téléphone ;</p>
    ...
    <p>– lorsque l’Utilisateur publie, dans les zones de commentaires libres du site web, des informations accessibles au public ;<br /> – lorsque l’Utilisateur autorise le site web d’un tiers à accéder à ses données ;</p>
    ...
    <br>
    <h2> MISE EN OEUVRE DES DROITS DES UTILISATEURS</h2>
    <p> En application de la réglementation applicable aux données à caractère personnel, les utilisateurs disposent des droits suivants, qu’ils peuvent exercer en faisant leur demande à l’adresse suivante : contact@valhainautauto.fr. · le droit d’accès : ils peuvent exercer leur droit d’accès, pour connaître les données personnelles les concernant. Dans ce cas, avant la mise en œuvre de ce droit, le site web peut demander une preuve de l’identité de l’utilisateur afin d’en vérifier l’exactitude. · le droit de rectification : si les données à caractère personnel détenues par le site web sont inexactes, ils peuvent demander la mise à jour des informations. · le droit de suppression des données : les utilisateurs peuvent demander la suppression de leurs données à caractère personnel, conformément aux lois applicables en matière de protection des données. · le droit à la limitation du traitement : les utilisateurs peuvent de demander au site web de limiter le traitement des données personnelles conformément aux hypothèses prévues par le RGPD. · le droit de s’opposer au traitement des données : les utilisateurs peuvent s’opposer à ce que ses données soient traitées conformément aux hypothèses prévues par le RGPD. · le droit à la portabilité : ils peuvent réclamer que le site web leur remette les données personnelles qui lui sont fournies pour les transmettre à un nouveau site web. Evolution de la présente clause Le site web se réserve le droit d’apporter toute modification à la présente clause relative à la protection des données à caractère personnel à tout moment. Si une modification est apportée à la présente clause de protection des données à caractère personnel, le site web s’engage à publier la nouvelle version sur son site. Le site web informera également les utilisateurs de la modification par messagerie électronique, dans un délai minimum de 15 jours avant la date d’effet. Si l’utilisateur n’est pas d’accord avec les termes de la nouvelle rédaction de la clause de protection des données à caractère personnel, il a la possibilité de supprimer son compte.</p>
    <h2> ARTICLE 8 – COOKIES</h2>
    <p> Le site Valhainautauto peut collecter automatiquement des informations standards. Toutes les informations collectées indirectement ne seront utilisées que pour suivre le volume, le type et la configuration du trafic utilisant ce site, pour en développer la conception et l’agencement et à d’autres fins administratives et de planification et plus généralement pour améliorer le service que nous vous offrons.</p>
    <h2> ARTICLE 9 – LOI APPLICABLE</h2>
    <p> Les présentes conditions générales d’utilisation sont soumises à l’application du droit français. Si les parties n’arrivent pas à résoudre un litige à l’amiable, le litige sera soumis à la compétence des tribunaux français.</p>
</div>
